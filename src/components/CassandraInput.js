                ...
                <SpaceBetween size="l">
                    ...
                    <Box textAlign="center">
                        <Button
                            variant="primary"
                            onClick={exportToPDF}
                            disabled={!allDatacentersHaveResults()}
                        >
                            Export to PDF
                        </Button>
                    </Box>
                            ...
                            <SpaceBetween size="m">
                                ...
                                <Table
                                    ...
                                    columnDefinitions={[
                                        ...
                                        {
                                            id: 'reads_on_demand',
                                            header: 'OnDemand Reads',
                                            cell: item => item.reads_on_demand
                                        },
                                        {
                                            id: 'writes_on_demand',
                                            header: 'OnDemand Writes',
                                            cell: item => item.writes_on_demand
                                        },
                                        {
                                            id: 'ttlDeletes',
                                            header: 'TTL Deletes',
                                        ...
                                        },
                                        {
                                            ...
                                            header: 'Provisioned Monthly Total',
                                            cell: item => item.provisioned_total
                                        },
                                        {
                                            id: 'on_demand_total',
                                            header: 'OnDemand Monthly Total',
                                            cell: item => item.on_demand_total
                                        }
                                    ]}
                                    sortingDisabled
                                    variant="bordered"
